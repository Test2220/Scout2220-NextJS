...
export default function Home() {
  ...
  return (
    ...
    <script src="./index.js" defer type="module"></script> */}
      ...
      <Script
        src="https://test2220.github.io/qr.js"
        strategy="beforeInteractive"
      />
      ...
      <div className="scouter">
          ...
          <div className="section">
            <div>
              ...
              <select name="startingPosition" id="startingPosition">
                ...
                <option defaultValue="In front of speaker">
                  In front of speaker
                </option>
            ...
            <div>
              ...
              <button id="minus" name="speakerNotesScoredAuto">
                -
              </button>
              <input defaultValue="0" id="speakerNotesScoredAuto"></input>
              <button id="plus" name="speakerNotesScoredAuto">
                +
              </button>
            </div>
            <div>
              <div>
                ...
                <button id="minus" name="ampNotesScoredAuto">
                  -
                </button>
                <input defaultValue="0" id="ampNotesScoredAuto"></input>
                <button id="plus" name="ampNotesScoredAuto">
                  +
                </button>
              </div>
              <div>
        ...
        <div>
          ...
          <div className="section">
            <div>
              <h2>Speaker notes scored</h2>
              <button id="minus" name="speakerNotesScoredTeleop">
                -
              </button>
              <input defaultValue="0" id="speakerNotesScoredTeleop"></input>
              <button id="plus" name="speakerNotesScoredTeleop">
                +
              </button>
            </div>
            <div>
              <h2>AMP notes scored</h2>
              <button id="minus" name="ampNotesScoredTeleop">
                -
              </button>
              <input defaultValue="0" id="ampNotesScoredTeleop"></input>
              <button id="plus" name="ampNotesScoredTeleop">
                +
              </button>
            </div>
        ...
        <div>
          ...
          <div className="section">
            ...
            <div>
              ...
              <label htmlFor="contributedToHarmony">
        ...
        <div>
          ...
          <textarea
            ...
            style={{ fontSize: "35px", rows: "5", cols: "45" }}
          ></textarea>

          <div>
            <button id="endOfForm" onClick={sendResults}>
              Submit
            </button>
          </div>
